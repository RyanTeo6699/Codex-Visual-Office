  ...
  return (
    <section className="rounded-[22px] border border-white/8 bg-[#121a24]/72 p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="rounded-md border border-emerald-200/16 bg-emerald-200/8 px-2 py-1 text-[10px] font-semibold text-emerald-100">
      ...
      {configs.length ? (
        <div className="mt-4 space-y-2">
          {configs.map((config) => (
            <div key={config.id} className="rounded-[14px] border border-white/[0.04] bg-white/[0.025] px-3 py-2.5">
              <div className="flex flex-wrap items-start justify-between gap-2">
                ...
                <div className="flex flex-wrap gap-1.5 text-[10px] font-semibold">
                  ...
                  <span className="rounded-md border border-sky-200/14 bg-sky-200/8 px-2 py-1 text-sky-100">
                    allowlisted
                  </span>
                </div>
              </div>
        ...
        <p className="mt-4 rounded-[12px] bg-black/12 px-3 py-2 text-xs text-slate-500">No quality gate configs available.</p>
      )}
